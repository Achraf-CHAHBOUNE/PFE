...
patterns: Dict[str, Pattern] = {
    '5min': re.compile(r'^(CALIS|MEIND|RAIND)[-_]APG43[_-]5_S\d+_A\d{4}$'),
    '15min': re.compile(r'^(CALIS|MEIND|RAIND)[-_]APG43[_-]15_S\d+_A\d{4}$'),
    'mgw': re.compile(r'^([A-Za-z0-9]+)MGW_S\d+_A\d{4}$')
}
